...
**⭐ اگر این پروژه را مفید یافتید، لطفاً در گیت‌هاب ستاره دهید!**
...
## 🔄 راهنمای پوش به گیت‌هاب

### اگر برای اولین بار پروژه را به گیت‌هاب پوش می‌کنید:

```bash
# 1. وارد مسیر پروژه شوید
cd D:\cinema-reservation

# 2. ریپازیتوری Git را مقداردهی اولیه کنید
git init

# 3. فایل‌ها را اضافه کنید
git add .

# 4. Commit ایجاد کنید
git commit -m "initial commit: Complete cinema reservation system with layered architecture"

# 5. ریپازیتوری از راه دور (Remote) را اضافه کنید
git remote add origin https://github.com/HosseinMpa/software-project.git

# 6. تغییرات را پوش کنید
git push -u origin main
```

### اگر قبلاً ریپازیتوری راه‌اندازی کرده‌اید:

```bash
# 1. وارد مسیر پروژه شوید
cd D:\cinema-reservation

# 2. وضعیت Git را بررسی کنید
git status

# 3. فایل‌های جدید را اضافه کنید
git add README.md
# یا برای همه فایل‌ها:
git add .

# 4. Commit ایجاد کنید
git commit -m "docs: Add comprehensive README with project architecture"

# 5. تغییرات را پوش کنید
git push origin main
```

### نکات مهم:
- ✅ مطمئن شوید به اینترنت متصل هستید
- ✅ Access Token یا نام کاربری/رمز عبور گیت‌هاب را آماده کنید
- ✅ اگر خطای `rejected` دیدید، ابتدا Pull کنید:
  ```bash
...
**پروژه شما اکنون آماده ارائه است! 🎬**
